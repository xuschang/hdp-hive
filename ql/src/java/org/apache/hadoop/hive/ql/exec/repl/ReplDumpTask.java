...
public class ReplDumpTask extends Task<ReplDumpWork> implements Serializable {
  ...
  void dumpTable(String dbName, String tblName, String validTxnList, Path dbRoot, long lastReplId, Hive db) throws Exception {
    try {
  ...
  void dumpConstraintMetadata(String dbName, String tblName, Path dbRoot, Hive db) throws Exception {
    try {
